            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
					 <?php if ($layout_module['position'] == 'section_bottom') { ?>
                    <option value="section_bottom" selected="selected"><?php echo $text_section_bottom; ?></option>
                    <?php } else { ?>
                    <option value="section_bottom"><?php echo $text_section_bottom; ?></option>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="section_bottom"><?php echo $text_section_bottom; ?></option>';
    html += '  </select></td>';
