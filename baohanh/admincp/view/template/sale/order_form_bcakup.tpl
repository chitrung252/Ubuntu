  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default dashboardform">
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-customer"><?php echo "khach hang"; ?></label>
                <div class="col-sm-10">
...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" data-type="productCode" name="product_order['+i+'][product_id]" id="itemNo_'+i+'" class="form-control autocomplete_txt" autocomplete="off"></td>';
	...
	html += '<td><input type="text" name="product_order['+i+'][price]" id="price_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
	html += '<td><input type="text" name="product_order['+i+'][quantity_order]" id="quantity_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
	html += '<td><input type="text" name="product_order['+i+'][total]" id="total_'+i+'" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
	html += '</tr>';
	$('table').append(html);
	i++;
});
...
"<?php echo $product['product_id'] ;?>|<?php echo $product['name'] ;?>|<?php echo $product['price'] ;?>",
<?php } ?>
];
//autocomplete script
