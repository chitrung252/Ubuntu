...
//Admin language (for email)
$query = $db->query("SELECT directory FROM `" . DB_PREFIX . "language` WHERE code = '".$config->get('config_admin_language')."'");
$admin_language = new Language($query->row['directory']);
$registry->set('admin_language', $admin_language);
...
// Scheduled Backup
$controller->addPreAction(new Action('module/scheduled_backup'));
